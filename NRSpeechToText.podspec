...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of NRSpeechToText.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Naveen Rana/NRSpeechToText'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Naveen Rana' => 'naveenrana1309@gmail.com' }
  s.source           = { :git => 'https://github.com/Naveen Rana/NRSpeechToText.git', :tag => s.version.to_s }
